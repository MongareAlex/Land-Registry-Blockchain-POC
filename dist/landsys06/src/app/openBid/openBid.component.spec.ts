...
describe('openBidComponent', () => {
  ...
  let mockopenBidService;
  let mockDataService

  beforeEach(async(() => {

    mockopenBidService = sinon.createStubInstance(openBidService);
    mockopenBidService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: openBidService, useValue: mockopenBidService },
