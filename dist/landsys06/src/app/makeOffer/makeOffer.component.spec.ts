...
describe('makeOfferComponent', () => {
  ...
  let mockmakeOfferService;
  let mockDataService

  beforeEach(async(() => {

    mockmakeOfferService = sinon.createStubInstance(makeOfferService);
    mockmakeOfferService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: makeOfferService, useValue: mockmakeOfferService },
